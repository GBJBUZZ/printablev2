...
const Genarate_quest = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center p-8 bg-gray-100">
      <h1 className="text-[42px] font-bold mb-4">Extract PDF</h1>
      ...
      <p className="text-[18px] w-[872px] ">
        Need only specific pages from a PDF? Our online PDF Extractor lets you
        select, extract, and save pages as a new document in seconds. Fast,
        secure, and free to use — no software required.
      </p>
