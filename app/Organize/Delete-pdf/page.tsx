...
const Genarate_quest = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center p-8 bg-gray-100">
      <h1 className="text-[42px] font-bold mb-4">Delete PDF</h1>
      ...
      <p className="text-[18px] w-[872px] ">
        Need to remove unwanted pages from a PDF? Our online PDF Page Deleter
        lets you quickly delete selected pages and save a clean, updated
        document in seconds. Simple, fast, and secure — no downloads required.
      </p>
