...
const Genarate_quest = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center p-8 bg-gray-100">
      <h1 className="text-[42px] font-bold mb-4">Organize PDF</h1>
      ...
      <p className="text-[18px] w-[872px] ">
        Need to rearrange your PDF pages? Our online PDF Organizer lets you
        reorder, move, rotate, and organize pages effortlessly. Get your
        document exactly the way you want — fast, secure, and no downloads
        required.
      </p>
