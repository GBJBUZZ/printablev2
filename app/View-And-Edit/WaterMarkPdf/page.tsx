...
useEffect(() => {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center p-8 bg-gray-100">
      <h1 className="text-[42px] font-bold mb-4">Watermark PDF</h1>
      ...
      <p className="text-[18px] w-[872px] ">
        Add text or image watermarks to your PDF to protect ownership and reinforce branding. Customize position, size, and transparency, then apply it across pages in seconds—no downloads required.
      </p>
