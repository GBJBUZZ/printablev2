...
useEffect(() => {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center p-8 bg-gray-100">
      <h1 className="text-[42px] font-bold mb-4">Crop PDF</h1>
      ...
      <p className="text-[18px] w-[872px] ">
        Remove unwanted margins and focus only on what matters. Our PDF Crop tool lets you trim pages precisely, adjust layouts, and export clean PDFs in seconds—quick, simple, and online.
      </p>
