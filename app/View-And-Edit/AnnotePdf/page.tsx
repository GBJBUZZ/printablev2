...
useEffect(() => {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center p-8 bg-gray-100">
      <h1 className="text-[42px] font-bold mb-4">Annote PDF</h1>
      <div className="bg-white rounded-[40px] border-[1.5px] border-[#D0D0D0] font-dm px-[15px] py-[30px] mb-8">
      ...
      <p className="text-[18px] w-[872px] ">
        Want to review or mark up a PDF clearly? Our PDF Annotation tool lets you highlight text, add comments, draw shapes, and leave notes directly on your document—perfect for collaboration and quick feedback.
      </p>
