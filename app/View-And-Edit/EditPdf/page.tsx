...
useEffect(() => {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center p-8 bg-gray-100">
      <h1 className="text-[42px] font-bold mb-4">Edit PDF</h1>
      ...
      <p className="text-[18px] w-[872px] ">
       Make quick changes to your PDF without starting from scratch. Edit text, add images, insert shapes, or annotate pages easily—everything happens online with no software required.
      </p>
