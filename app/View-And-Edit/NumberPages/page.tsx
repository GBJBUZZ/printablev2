...
useEffect(() => {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center p-8 bg-gray-100">
      <h1 className="text-[42px] font-bold mb-4">Number Pages</h1>
      ...
      <p className="text-[18px] w-[872px] ">
        Add clear, consistent page numbers to your PDF in seconds. Customize position, format, and range to keep documents organized and professional—ideal for reports, contracts, and print-ready files.
      </p>
