...
useEffect(() => {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center p-8 bg-gray-100">
      <h1 className="text-[42px] font-bold mb-4">PDF Reader</h1>
      ...
      View PDF files instantly with a fast, intuitive reader. Navigate pages smoothly, zoom with precision, and read documents online without downloads or distractions.
      </p>
