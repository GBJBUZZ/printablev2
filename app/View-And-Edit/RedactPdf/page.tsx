...
useEffect(() => {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center p-8 bg-gray-100">
      <h1 className="text-[42px] font-bold mb-4">Redact PDF</h1>
      ...
      <p className="text-[18px] w-[872px] ">
        Protect sensitive information by permanently removing text and content from your PDFs. Our Redact PDF tool helps you securely hide confidential data before sharing—fast, reliable, and done online..
      </p>
