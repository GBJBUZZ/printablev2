...
const Genarate_quest = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center p-8 bg-gray-100">
      <h1 className="text-[42px] font-bold mb-4">Unlock PDF</h1>
      ...
      <p className="text-[18px] w-[872px] ">
        Forgot your PDF password? Our online PDF Unlocker helps you remove
        password protection and unlock secured PDF files in seconds. Fast,
        secure, and easy to use — no downloads required.
      </p>
