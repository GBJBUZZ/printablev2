...
const Genarate_quest = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center p-8 bg-gray-100">
      <h1 className="text-[42px] font-bold mb-4">Lock PDF</h1>
      ...
      <p className="text-[18px] w-[872px] ">
        Want to protect your PDF file? Our online PDF Locker lets you add
        password protection to your PDF and keep your documents secure. Fast,
        safe, and easy to use — no downloads required.
      </p>
